...
},{"./_baseClone":"../../node_modules/lodash/_baseClone.js"}],"../../node_modules/lodash/compact.js":[function(require,module,exports) {
/**
...
},{"./_arrayPush":"../../node_modules/lodash/_arrayPush.js","./_isFlattenable":"../../node_modules/lodash/_isFlattenable.js"}],"../../node_modules/lodash/isArrayLikeObject.js":[function(require,module,exports) {
...
},{"./_baseDifference":"../../node_modules/lodash/_baseDifference.js","./_baseFlatten":"../../node_modules/lodash/_baseFlatten.js","./_baseRest":"../../node_modules/lodash/_baseRest.js","./isArrayLikeObject":"../../node_modules/lodash/isArrayLikeObject.js"}],"../../node_modules/lodash/_baseFunctions.js":[function(require,module,exports) {
var arrayFilter = require('./_arrayFilter'),
...
},{"./_arrayFilter":"../../node_modules/lodash/_arrayFilter.js","./isFunction":"../../node_modules/lodash/isFunction.js"}],"../../node_modules/lodash/functions.js":[function(require,module,exports) {
...
},{"./_baseFunctions":"../../node_modules/lodash/_baseFunctions.js","./keys":"../../node_modules/lodash/keys.js"}],"../../node_modules/lodash/isString.js":[function(require,module,exports) {
var baseGetTag = require('./_baseGetTag'),
    isArray = require('./isArray'),
    isObjectLike = require('./isObjectLike');
...
},{"./_baseIndexOf":"../../node_modules/lodash/_baseIndexOf.js","./isArrayLike":"../../node_modules/lodash/isArrayLike.js","./isString":"../../node_modules/lodash/isString.js","./toInteger":"../../node_modules/lodash/toInteger.js","./values":"../../node_modules/lodash/values.js"}],"../../node_modules/lodash/isPlainObject.js":[function(require,module,exports) {
var baseGetTag = require('./_baseGetTag'),
    getPrototype = require('./_getPrototype'),
    isObjectLike = require('./isObjectLike');
...
},{"./isObjectLike":"../../node_modules/lodash/isObjectLike.js","./isPlainObject":"../../node_modules/lodash/isPlainObject.js"}],"../../node_modules/lodash/_assignMergeValue.js":[function(require,module,exports) {
var baseAssignValue = require('./_baseAssignValue'),
    eq = require('./eq');
...
},{"./_createBaseFor":"../../node_modules/lodash/_createBaseFor.js"}],"../../node_modules/lodash/_safeGet.js":[function(require,module,exports) {
/**
...
},{"./_baseMerge":"../../node_modules/lodash/_baseMerge.js","./_createAssigner":"../../node_modules/lodash/_createAssigner.js"}],"../../node_modules/lodash/_baseToString.js":[function(require,module,exports) {
var Symbol = require('./_Symbol'),
    arrayMap = require('./_arrayMap'),
    isArray = require('./isArray'),
    isSymbol = require('./isSymbol');
...
},{}],"../../node_modules/cloudinary-core/cloudinary-core.js":[function(require,module,exports) {
var define;
  ...
  return (
    ...
    /******/
    {
      ...
      function (module, __webpack_exports__, __webpack_require__) {
        ...
        var isElement_root_isElement_default =
        /*#__PURE__*/
        __webpack_require__.n(isElement_root_isElement_); // EXTERNAL MODULE: external {"commonjs":"lodash/isFunction","commonjs2":"lodash/isFunction","amd":"lodash/isFunction","root":["_","isFunction"]}


        var isFunction_root_isFunction_ = __webpack_require__("lodash/isFunction");

        var isFunction_root_isFunction_default =
        /*#__PURE__*/
        __webpack_require__.n(isFunction_root_isFunction_); // EXTERNAL MODULE: external {"commonjs":"lodash/trim","commonjs2":"lodash/trim","amd":"lodash/trim","root":["_","trim"]}


        var trim_root_trim_ = __webpack_require__("lodash/trim");

        var trim_root_trim_default =
        /*#__PURE__*/
        __webpack_require__.n(trim_root_trim_); // CONCATENATED MODULE: ./src/util/lazyLoad.js
        ...
        function () {
          ...
          configuration_createClass(Configuration, [{
            ...
            value: function fromEnvironment() {
              ...
              if (typeof process !== "undefined" && process !== null && process.env && "cloudinary://582425593877469:pqtrtzHq-dWWQjBjQHQsc3hyBow@davrosh") {
                cloudinary_url = "cloudinary://582425593877469:pqtrtzHq-dWWQjBjQHQsc3hyBow@davrosh";
...
},{"lodash/assign":"../../node_modules/lodash/assign.js","lodash/cloneDeep":"../../node_modules/lodash/cloneDeep.js","lodash/compact":"../../node_modules/lodash/compact.js","lodash/difference":"../../node_modules/lodash/difference.js","lodash/functions":"../../node_modules/lodash/functions.js","lodash/identity":"../../node_modules/lodash/identity.js","lodash/includes":"../../node_modules/lodash/includes.js","lodash/isArray":"../../node_modules/lodash/isArray.js","lodash/isElement":"../../node_modules/lodash/isElement.js","lodash/isFunction":"../../node_modules/lodash/isFunction.js","lodash/isPlainObject":"../../node_modules/lodash/isPlainObject.js","lodash/isString":"../../node_modules/lodash/isString.js","lodash/merge":"../../node_modules/lodash/merge.js","lodash/trim":"../../node_modules/lodash/trim.js","buffer":"../../node_modules/buffer/index.js","process":"../../node_modules/process/browser.js"}],"../../utils/getCloudinaryUrl.js":[function(require,module,exports) {
...
var _require = require('cloudinary-core'),
    Cloudinary = _require.Cloudinary; // IMPORTANT: the Parcel bundler will only let us reference env variables in the
...
module.exports = function (doc) {
  ...
  var _doc$photo$split = doc.photo.split(/\/(.+)/),
      _doc$photo$split2 = _slicedToArray(_doc$photo$split, 2),
      version = _doc$photo$split2[0],
      url = _doc$photo$split2[1]; // console.log(version, url);


  var cloudName = "davrosh"; // console.log(cloudName);
...
//   });
// };
},{"cloudinary-core":"../../node_modules/cloudinary-core/cloudinary-core.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJkZXZlbG9wbWFwczQyIiwiYSI6ImNrZ2gydThoYTFlYTQycnMxb2syN3cydjEifQ.FRsUz6xtU5T5X4hSN3v5dA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/abdevelopmaps42/ckgi0g2lj23y319obi0zougdl',
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51HflR7Cb2crGjsnDRgHtgPUEfTwo9WIYI3YPf0KxF6nJMIfxQLa1XApH6qRnLQ43s2yRBOZiaZuoNXqDO3WZGnSK00l6J1aMqf');
            _context.prev = 1;
            _context.next = 4;
...
var _getCloudinaryUrl = _interopRequireDefault(require("./../../utils/getCloudinaryUrl"));
...
if (userDataForm) {
  ...
  var elemUserPhoto = userDataForm.querySelector('.form__user-photo'); // whenever the user selects a photo, we change the one displayed to the one
  // they've selected.
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee(e) {
      var form, res, user, image;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); // This is needed in order to send files.

              form = new FormData();
              form.append('name', document.getElementById('name').value);
              form.append('email', document.getElementById('email').value);
              form.append('photo', document.getElementById('photo').files[0]);
              document.querySelector('.btn--save-settings').textContent = 'Updating...'; // console.log(form);
              // const name = document.getElementById('name').value;
              // const email = document.getElementById('email').value;
              // updateSettings({ name, email }, 'data');
            ...
            case 8:
              ...
              if (user.remoteSaved) {
                image = (0, _getCloudinaryUrl.default)(user);
              } //change user photo without reloading the page.


              elemUserPhoto.src = user.remoteSaved ? image : "img/users/".concat(user.photo);
              document.querySelector('.nav__user-img').src = user.remoteSaved ? image : "img/users/".concat(user.photo);
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // data-tour-id gets automatically converted to dataset.tourId
