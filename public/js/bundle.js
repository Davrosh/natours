      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              res = _context.sent;
              document.querySelector('.btn--save-settings').textContent = 'Save settings'; //change user photo without reloading the page.

              elemUserPhoto.src = "img/users/".concat(res.data.data.user.photo);
